...
page_title: "ONTAP: Licensing_Licenses"
subcategory: "Cluster"
description: |-
  Add/Remove License from ONTAP
---

# Resource licensing_licenses
...
### Terraform Import
```shell
terraform import netapp-ontap_cluster_licensing_licenses.import_license fcp,cluster5
```
...
resource "netapp-ontap_cluster_licensing_licenses" "license_import" {
  cx_profile_name = "cluster4"
  keys            = ["fake"]
}
```