...
subcategory: "NAS"
description: |-
  Cifs Local Groups resource
---

# Resource Local Groups

Create/Modify/Delete a Local Groups resource
...
resource "netapp-ontap_cifs_local_groups" "example" {
...
### Terraform Import
 ...
 For example
 ```shell
  terraform import netapp-ontap_cifs_local_groups.example grp1,svm1,cluster4
 ```
...
```terraform
import {
  to = netapp-ontap_cifs_local_groups.grp_import
...
resource "netapp-ontap_cifs_local_groups" "grp1_import" {
  cx_profile_name = "cluster4"
  name       = "grp1"
  svm_name   = "svm1"
}
