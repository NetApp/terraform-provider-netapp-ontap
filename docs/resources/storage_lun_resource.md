...
page_title: "netapp-ontap_storage_lun Resource - terraform-provider-netapp-ontap"
subcategory: "Storage"
description: |-
  StorageLun resource
---
...
For example
 ```shell
  terraform import netapp-ontap_storage_lun.example lun,vol,svm,cluster4
 ```
...
```terraform
import {
  to = netapp-ontap_storage_lun.lun_import
...
resource "netapp-ontap_storage_lun" "lun_import" {
  cx_profile_name = "cluster4"
  name            = "ACC-import-lun"
  os_type         = "linux"
