...
func TestGetListStorageVolumeSnapshots(t *testing.T) {
	errorHandler := utils.NewErrorHandler(context.Background(), &diag.Diagnostics{})
	badRecord := struct{ Volume int }{1}
	var recordInterface map[string]any
	err := mapstructure.Decode(basicStorageVolumeSnapshotRecord, &recordInterface)
	if err != nil {
		panic(err)
	}
	...
	var wantOneRecord = []StorageVolumeSnapshotGetDataModelONTAP{basicStorageVolumeSnapshotRecord}
	var wantTwoRecords = []StorageVolumeSnapshotGetDataModelONTAP{basicStorageVolumeSnapshotRecord, basicStorageVolumeSnapshotRecord}

	responses := map[string][]restclient.MockResponse{
		"test_no_records_1": {
			{ExpectedMethod: "GET", ExpectedURL: "storage/volumes/1234/snapshots", StatusCode: 200, Response: noRecordsResponse, Err: nil},
		},
		"test_one_record_1": {

			{ExpectedMethod: "GET", ExpectedURL: "storage/volumes/1234/snapshots", StatusCode: 200, Response: oneRecordResponse, Err: nil},
		},
		"test_two_records_1": {
			{ExpectedMethod: "GET", ExpectedURL: "storage/volumes/1234/snapshots", StatusCode: 200, Response: twoRecordsResponse, Err: nil},
		},
		"test_decode_error": {
			{ExpectedMethod: "GET", ExpectedURL: "storage/volumes/1234/snapshots", StatusCode: 200, Response: decodeErrorResponse, Err: nil},
		},
	}
	tests := []struct {
		name      string
