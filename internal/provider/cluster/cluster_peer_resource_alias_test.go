...
func TestAccClusterPeerResourceAlias(t *testing.T) {
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			// {
			// 	Config: testAccClusterPeerResourceConfigAlias("10.193.180.57", "10.193.176.187"),
			// 	Check: resource.ComposeTestCheckFunc(
			// 		resource.TestCheckResourceAttr("netapp-ontap_cluster_peers_resource.example", "remote.ip_addresses.0", "10.193.180.57"),
			// 	),
			// },
			// Update applications
			// {
			// 	Config: testAccClusterPeerResourceConfigAlias("10.193.180.56", "10.193.176.189"),
			// 	Check: resource.ComposeTestCheckFunc(
			// 		resource.TestCheckResourceAttr("netapp-ontap_cluster_peers_resource.example", "remote.ip_addresses.0", "10.193.176.189"),
			// 	),
			// },
			// Import and read
			{
