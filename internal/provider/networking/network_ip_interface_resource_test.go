...
func TestAccNetworkIpInterfaceResource(t *testing.T) {
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			{
				Config:      testAccNetworkIPInterfaceResourceConfigHomePortNode("non-existant", "10.10.10.10", "e0d", "bsuhas-vsim1", "default-data-files"),
				ExpectError: regexp.MustCompile("Code:\"2621462\""),
			},
			// non-existant home node
			{
				Config:      testAccNetworkIPInterfaceResourceConfigHomePortNode("tf_acc_svm", "10.10.10.10", "e0d", "non-existant_home_node", "default-data-files"),
				ExpectError: regexp.MustCompile("Code:\"53281680\""),
			},
			// non-existant broadcast domain
			{
				Config:      testAccNetworkIPInterfaceResourceConfigBroadcastDomain("tf_acc_svm", "10.10.10.10", "non-existant_broadcast_domain", "default-data-files"),
			...
			{
				Config:      testAccNetworkIPInterfaceResourceConfigHomePortNode("tf_acc_svm", "10.10.10.10", "", "", "default-data-files"),
				ExpectError: regexp.MustCompile("Code:\"1967111\""),
			},

			// Create and Read (with Home Port & Node)
			{
				Config: testAccNetworkIPInterfaceResourceConfigHomePortNode("tf_acc_svm", "10.10.10.10", "e0d", "bsuhas-vsim1", "default-data-files"),
			...
			{
				Config: testAccNetworkIPInterfaceResourceConfigHomePortNode("tf_acc_svm", "10.10.10.20", "e0d", "bsuhas-vsim1", "default-data-iscsi"),
				Check: resource.ComposeTestCheckFunc(
					resource.TestCheckResourceAttr("netapp-ontap_network_ip_interface.example", "name", "test-interface-1"),
			...
			{
				Config: testAccNetworkIPInterfaceResourceConfigBroadcastDomain("tf_acc_svm", "10.10.20.10", "Default", "default-data-files"),
				Check: resource.ComposeTestCheckFunc(
			...
			{
				Config: testAccNetworkIPInterfaceResourceConfigBroadcastDomain("tf_acc_svm", "10.10.20.20", "Default", "default-data-iscsi"),
				Check: resource.ComposeTestCheckFunc(
					resource.TestCheckResourceAttr("netapp-ontap_network_ip_interface.example", "name", "test-interface-2"),
