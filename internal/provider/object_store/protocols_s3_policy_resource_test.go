...
func TestAccProtocolsS3PolicyResource(t *testing.T) {
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			{
				Config: testAccProtocolsS3PolicyResourceConfig("svm1"),
				Check: resource.ComposeAggregateTestCheckFunc(
					resource.TestCheckResourceAttr("netapp-ontap_s3_policy.example", "name", "svm1"),
					resource.TestCheckResourceAttr("netapp-ontap_s3_policy.example", "svm_name", "svm1"),
			...
			{
				Config: testAccProtocolsS3PolicyResourceConfigUpdate("svm1"),
				Check: resource.ComposeAggregateTestCheckFunc(
					resource.TestCheckResourceAttr("netapp-ontap_s3_policy.example", "name", "svm1"),
