...
func TestAccCifsLocalGroupResourceAlias(t *testing.T) {
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			// {
			// 	Config: testAccCifsLocalGroupResourceConfigAlias("terraform", "group1"),
			// 	Check: resource.ComposeTestCheckFunc(
			// 		// check name
			// 		resource.TestCheckResourceAttr("netapp-ontap_protocols_cifs_local_group_resource.example1", "name", "group1"),
			// 		// check svm_name
			// 		resource.TestCheckResourceAttr("netapp-ontap_protocols_cifs_local_group_resource.example1", "svm_name", "terraform"),
			// 		// check ID
			...
			// update test
			// {
			// 	Config: testAccCifsLocalGroupResourceConfigAlias("terraform", "newgroup"),
			// 	Check: resource.ComposeTestCheckFunc(
			...
			// 	ImportState:   true,
			// 	ImportStateId: fmt.Sprintf("%s,%s,%s", "Administrators", "terraform", "cluster4"),
			// 	Check: resource.ComposeTestCheckFunc(
			// 		resource.TestCheckResourceAttr("netapp-ontap_protocols_cifs_local_group_resource.example1", "svm_name", "terraform"),
