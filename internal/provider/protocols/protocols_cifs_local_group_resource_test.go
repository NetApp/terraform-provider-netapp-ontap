		...
		Steps: []resource.TestStep{
			...
			// create with basic argument
			{
				...
				Check: resource.ComposeTestCheckFunc(
					// check name
					resource.TestCheckResourceAttr("netapp-ontap_cifs_local_group_member.example1", "name", "group1"),
					// check svm_name
			...
			// update test
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr("netapp-ontap_cifs_local_group_member.example1", "name", "newgroup"),
					// check id
					resource.TestCheckResourceAttrSet("netapp-ontap_cifs_local_group_member.example1", "id")),
			},
			// Test importing a resource
			{
				...
				Check: resource.ComposeTestCheckFunc(
					resource.TestCheckResourceAttr("netapp-ontap_cifs_local_group_member.example1", "svm_name", "ansibleSVM"),
					resource.TestCheckResourceAttr("netapp-ontap_cifs_local_group_member.example1", "name", "Administrators"),
