		...
		Steps: []resource.TestStep{
			...
			// Read testing
			{
				...
				Check: resource.ComposeTestCheckFunc(
					resource.TestCheckResourceAttr("netapp-ontap_protocols_cifs_share.example", "name", "acc_test_cifs_share"),
					resource.TestCheckResourceAttr("netapp-ontap_protocols_cifs_share.example", "comment", "this is a comment"),
					resource.TestCheckResourceAttr("netapp-ontap_protocols_cifs_share.example", "continuously_available", "false"),
				),
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					resource.TestCheckResourceAttr("netapp-ontap_protocols_cifs_share.example", "name", "acc_test_cifs_share"),
					resource.TestCheckResourceAttr("netapp-ontap_protocols_cifs_share.example", "comment", "update comment"),
					resource.TestCheckResourceAttr("netapp-ontap_protocols_cifs_share.example", "continuously_available", "true"),
				),
			},
			// Test importing a resource
			{
				ResourceName:  "netapp-ontap_protocols_cifs_share.example",
				ImportState:   true,
				ImportStateId: fmt.Sprintf("%s,%s,%s", "acc_test_cifs_share_import", "tfsvm", "clustercifs"),
				Check: resource.ComposeTestCheckFunc(
					resource.TestCheckResourceAttr("netapp-ontap_protocols_cifs_share.example", "name", "acc_test_cifs_share_import"),
				),
			},
		},
	})
...
resource "netapp-ontap_protocols_cifs_share" "example" {
