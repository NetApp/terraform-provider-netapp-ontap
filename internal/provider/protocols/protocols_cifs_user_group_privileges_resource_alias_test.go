...
func TestAccCifsUserGroupPrivilegesResourceAlias(t *testing.T) {
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			// {
			// 	Config: testAccCifsUserGroupPrivilegesResourceConfigAlias("terraform", "accuser1", "sechangenotifyprivilege"),
			// 	Check: resource.ComposeTestCheckFunc(
			// 		// check name
			// 		resource.TestCheckResourceAttr("netapp-ontap_protocols_cifs_user_group_privilege_resource.example1", "name", "accuser1"),
			// 		// check svm_name
			// 		resource.TestCheckResourceAttr("netapp-ontap_protocols_cifs_user_group_privilege_resource.example1", "svm_name", "terraform"),
			// 		// check ID
			...
			// {
			// 	Config: testAccCifsUserGroupPrivilegesResourceConfigAlias("terraform", "accuser1", "setakeownershipprivilege"),
			// 	Check: resource.ComposeTestCheckFunc(
			// 		// check user name
			// 		resource.TestCheckResourceAttr("netapp-ontap_protocols_cifs_user_group_privilege_resource.example1", "name", "accuser1"),
			// 		// check id
			...
			// 	ImportState:   true,
			// 	ImportStateId: fmt.Sprintf("%s,%s,%s", "accuser1", "terraform", "cluster4"),
			// 	Check: resource.ComposeTestCheckFunc(
			// 		resource.TestCheckResourceAttr("netapp-ontap_protocols_cifs_user_group_privilege_resource.example1", "svm_name", "terraform"),
			// 		resource.TestCheckResourceAttr("netapp-ontap_protocols_cifs_user_group_privilege_resource.example1", "name", "accuser1"),
