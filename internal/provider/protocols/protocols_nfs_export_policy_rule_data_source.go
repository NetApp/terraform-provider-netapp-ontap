...
// NewExportPolicyRuleDataSourceAlias is a helper function to simplify the provider implementation.
func NewExportPolicyRuleDataSourceAlias() datasource.DataSource {
	return &ExportPolicyRuleDataSource{
		config: connection.ResourceOrDataSourceConfig{
