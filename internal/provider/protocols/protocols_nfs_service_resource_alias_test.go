...
func TestAccNfsServiceResourceAlias(t *testing.T) {
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			// Test error
			{
				Config:      testAccNfsServiceResourceConfigAlias("non-existant", "false"),
				ExpectError: regexp.MustCompile("svm non-existant not found"),
			},
			// Create and read
			{
				Config: testAccNfsServiceResourceConfigAlias("tf_acc_svm", "false"),
				Check: resource.ComposeTestCheckFunc(
					resource.TestCheckResourceAttr("netapp-ontap_protocols_nfs_service_resource.example", "svm_name", "tf_acc_svm"),
			...
			// update and read
			{
				Config: testAccNfsServiceResourceConfigAlias("tf_acc_svm", "true"),
				Check: resource.ComposeTestCheckFunc(
					resource.TestCheckResourceAttr("netapp-ontap_protocols_nfs_service_resource.example", "svm_name", "tf_acc_svm"),
