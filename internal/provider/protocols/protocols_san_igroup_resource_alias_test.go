...
func TestAccProtocolsSanIgroupResourceAlias(t *testing.T) {
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			{
				Config: testAccProtocolsSanIgroupResourceBasicConfigAlias("acc_test2", "tf_acc_svm"),
			...
			{
				Config: testAccProtocolsSanIgroupResourceUpdateConfigAlias("acc_test2", "tf_acc_svm", "windows", "test_acc"),
				Check: resource.ComposeTestCheckFunc(
