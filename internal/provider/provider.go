...
func (p *ONTAPProvider) Resources(ctx context.Context) []func() resource.Resource {
	return []func() resource.Resource{
		...
		name_services.NewNameServicesUnixGroupResource,
		name_services.NewNameServicesUnixUserResource,
		...
		storage.NewStorageNvmeNamespaceResource,
		storage.NewStorageQuotaRuleResource,
		storage.NewStorageQtreeResource,
		storage.NewStorageVolumeCloneResource,
...
func (p *ONTAPProvider) DataSources(ctx context.Context) []func() datasource.DataSource {
	return []func() datasource.DataSource{
		...
		name_services.NewNameServicesUnixGroupDataSource,
		name_services.NewNameServicesUnixGroupsDataSource,
		name_services.NewNameServicesUnixUserDataSource,
		name_services.NewNameServicesUnixUsersDataSource,
		...
		networking.NewIPspaceDataSource,
		networking.NewIPspacesDataSource,
		...
		protocols.NewProtocolsFpolicyExternalEngineDataSource,
		protocols.NewProtocolsFpolicyExternalEnginesDataSource,
		...
		protocols.NewProtocolsS3BucketDataSource,
		protocols.NewProtocolsS3BucketsDataSource,
		...
		protocols.NewProtocolsS3ServiceDataSource,
		protocols.NewProtocolsS3ServicesDataSource,
		protocols.NewProtocolsS3UserDataSource,
		protocols.NewProtocolsS3UsersDataSource,
		...
		protocols.NewProtocolsSVMAuditDataSource,
		protocols.NewProtocolsSVMAuditsDataSource,
		...
		storage.NewStorageNvmeNamespaceDataSource,
		storage.NewStorageNvmeNamespacesDataSource,
		...
		storage.NewStorageVolumeCloneDataSource,
		storage.NewStorageVolumeClonesDataSource,
