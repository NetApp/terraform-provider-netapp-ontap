...
func (p *ONTAPProvider) Resources(ctx context.Context) []func() resource.Resource {
	return []func() resource.Resource{
		...
		protocols.NewCifsLocalGroupsMembersResource,
		protocols.NewCifsLocalUsersResource,
		protocols.NewCifsServiceResource,
		protocols.NewCifsUsersGroupsPrivilegesResource,
...
func (p *ONTAPProvider) DataSources(ctx context.Context) []func() datasource.DataSource {
	return []func() datasource.DataSource{
		...
		protocols.NewCifsUsersGroupsPrivilegeDataSource,
		protocols.NewCifsUsersGroupsPrivilegesDataSource,
