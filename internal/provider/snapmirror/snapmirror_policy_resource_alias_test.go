...
func TestAccSnapmirrorPolicyResourceAlias(t *testing.T) {
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			{
				Config:      testAccSnapmirrorPolicyResourceBasicConfigAlias("non-existent"),
			...
			// Test create snapmirror policy basic
			{
				...
				Check: resource.ComposeTestCheckFunc(
					resource.TestCheckResourceAttr("netapp-ontap_snapmirror_policy_resource.example", "name", "tf_acc_snapmirror_policy"),
				),
			},
			...
			// Test create sync type snapmirror policy
			{
				...
				Check: resource.ComposeTestCheckFunc(
					resource.TestCheckResourceAttr("netapp-ontap_snapmirror_policy_resource.sync_example", "name", "tf_acc_snapmirror_policy_sync"),
