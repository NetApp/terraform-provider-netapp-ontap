...
func TestAccStorageLunResouceAlias(t *testing.T) {
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			{
				Config:      testAccStorageLunResourceConfigAlias("ACC-lun", "tf_acc_svm", "unnownsvm", "linux", 1048576),
				ExpectError: regexp.MustCompile("917927"),
			},
			// Create storage lun and read without size_unit
			{
				Config: testAccStorageLunResourceConfigAlias("ACC-lun", "tf_acc_svm", "tf_acc_volume", "linux", 1048576),
				Check: resource.ComposeTestCheckFunc(
					resource.TestCheckResourceAttr("netapp-ontap_storage_lun_resource.example", "name", "/vol/tf_acc_volume/ACC-lun"),
					resource.TestCheckResourceAttr("netapp-ontap_storage_lun_resource.example", "svm_name", "tf_acc_svm"),
			...
			// Update name
			{
				Config: testAccStorageLunResourceConfigAlias("ACC-lun2", "tf_acc_svm", "tf_acc_volume", "linux", 1048576),
				Check: resource.ComposeTestCheckFunc(
