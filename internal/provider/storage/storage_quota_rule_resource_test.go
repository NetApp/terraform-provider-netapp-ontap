...
func TestAccStorageQuotaRuleResource(t *testing.T) {
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			{
				Config: testAccStorageQuotaRuleResourceBasicConfig("tf_acc_volume", "tf_acc_svm", 100, 80),
			...
			// Update a option
			{
				Config: testAccStorageQuotaRuleResourceBasicConfig("tf_acc_volume", "tf_acc_svm", 100, 70),
				Check: resource.ComposeTestCheckFunc(
