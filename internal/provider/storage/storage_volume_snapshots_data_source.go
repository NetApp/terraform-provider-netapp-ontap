...
// NewStorageVolumeSnapshotsDataSourceAlias is a helper function to simplify the provider implementation.
func NewStorageVolumeSnapshotsDataSourceAlias() datasource.DataSource {
	return &StorageVolumeSnapshotsDataSource{
		config: connection.ResourceOrDataSourceConfig{
