...
CATEGORIES = {
    ...
    'object-store': [
        ...
        "protocols_s3_service_data_source.md",
        "protocols_s3_services_data_source.md", 
        "protocols_s3_service_resource.md",
    ...
    'storage': [
        ...
        "storage_qos_policy_resource.md",
        ...
        "storage_volume_clone_data_source.md",
        "storage_volume_clones_data_source.md",
        "storage_volume_clone_resource.md",
